...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --row-hover: rgba(90, 103, 216, 0.06);
        }
        ...
        /* Hover effects for Add / Edit / Delete buttons */
        .btn-add-item:hover,
        .btn-add-item:focus {
        ...
        .btn-delete:focus {
            transform: translateY(-3px);
            box-shadow: 0 8px 20px rgba(226, 34, 34, 0.25);
            color: #ffffff;
        ...
        /* Ensure keyboard focus is visible (accessibility) */
        .btn-add-item:focus-visible,
        .btn-edit:focus-visible,
        .btn-delete:focus-visible {
            box-shadow: 0 0 0 4px rgba(90, 103, 216, 0.18), var(--shadow-sm);
        }
        ...
        /* Hover row: disederhanakan dan disinkronkan dengan mode gelap melalui variable --row-hover */
        .table tbody tr {
        ...
        /* Penyesuaian warna badge saat dark-mode agar kontras tetap baik */
        .dark-mode .badge-category {
            background-color: rgba(0, 119, 255, 1);
            color: var(--text-dark);
        }

        /* Penyesuaian zebra striping untuk dark-mode agar tidak terlalu terang */
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="section-card">
                    ...
                    <table class="table table-hover align-center">
                        <thead class="table-primary">
                            <tr>
                                ...
                                <?php if ($role === 'admin'): ?>
                                    <th scope="col" class="text-center" style="min-width: 250px;">Aksi</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                        <!-- tabel data barang -->
                ...
                <!-- Paginasi: dipindahkan di bawah tabel -->
